...
int main()
{
    ...
    while (true)
    {
        ...
        for (int i = 0; i < 3; i++)
        {
            ...
            nizBrojeva[i] = htonl(nizBrojeva[i]); //priprema podatka za slanje, treba nam konverzija iz host u network zapis tj. htonl()
        }
        ...
        {
            int* primljenaVrednost = (int*)dataBuffer; //pristup u memoriji sadrzaju poruke i adekvatno kastovanje pokazivaca
            int zbir = ntohl(*primljenaVrednost); //primena funkcije ntohl() jer je poruka u mreznom redosledu 
