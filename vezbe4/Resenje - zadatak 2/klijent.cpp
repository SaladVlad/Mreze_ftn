...
int main()
{
    ...
    //korak 4. ucitati iz komandne linije port servera ka kome ce se slati poruke
    printf("Unesite port servera (17010 or 17011):\n");
    ...
    //ucitanu vrednost porta smestamo u polje sin_port serverske adresne strukture
    ...
    while (true)
    {
        ...
        //korak 5. gasimo klijenta ako je uneto "kraj"
